...
{
    private static readonly KeyAlgorithmProvider signatureAlgorithmProvider = new();

    private readonly X509Certificate certificate;
    private readonly CertificateStore certificateStore = new();
    ...
    {
        certificateStore.Add(certificates);
    }
    ...
    private IList<X509Certificate> FindIssuers()
    {
        ...
        var certificates = certificateStore
            ...
            .Select(cert => new { IsRoot = cert.IssuerDN.Equivalent(cert.SubjectDN), Cert = cert });
        ...
        var builderParams = new PkixBuilderParameters(rootCerts, target) { IsRevocationEnabled = false };
        ...
        var fullChain = result.CertPath.Certificates.ToArray();
        return fullChain;
    }
